...
| <a name="input_env_map"></a> [env\_map](#input\_env\_map) | n/a | <pre>map(object({<br>    env_name = string<br>  }))</pre> | <pre>{<br>  "Non Production": {<br>    "env_name": "np"<br>  },<br>  "Pre Production": {<br>    "env_name": "pre"<br>  },<br>  "Production": {<br>    "env_name": "prod"<br>  }<br>}</pre> | no |
| <a name="input_env_type_map"></a> [env\_type\_map](#input\_env\_type\_map) | n/a | <pre>map(object({<br>    location_name = string<br>  }))</pre> | <pre>{<br>  "Non Production": {<br>    "env_type": "np"<br>  },<br>  "Pre Production": {<br>    "env_type": "pre"<br>  },<br>  "Production": {<br>    "env_type": "prod"<br>  }<br>}</pre> | no |
...
| <a name="input_redis_map"></a> [redis\_map](#input\_redis\_map) | Map for t-shirt size redis instances | <pre>map(object({<br>    sku_name            = optional(string)<br>    redis_version       = optional(number)<br>    cluster_shard_count = optional(number)<br>    capacity            = optional(number)<br>    redis_configuration = object({<br>      maxmemory_reserved = number<br>      maxmemory_delta    = number<br>      maxmemory_policy   = string<br>    })<br>    patch_schedule = list(object({<br>      day_of_week        = string<br>      start_hour_utc     = number<br>      maintenance_window = string<br>    }))<br>    redis_firewall_rules = list(object({<br>      name     = string<br>      start_ip = string<br>      end_ip   = string<br>    }))<br>  }))</pre> | <pre>{<br>  "np_large": {<br>    "capacity": 5,<br>    "cluster_shard_count": 4,<br>    "patch_schedule": [<br>      {<br>        "day_of_week": "Monday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      },<br>      {<br>        "day_of_week": "Tuesday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      }<br>    ],<br>    "redis_configuration": {<br>      "maxfragmentationmemory_reserved": 2704,<br>      "maxmemory_delta": 2704,<br>      "maxmemory_policy": "allkeys-lru",<br>      "maxmemory_reserved": 2704<br>    },<br>    "redis_firewall_rules": [<br>      {<br>        "end_ip": "11.0.0.0",<br>        "name": "access_to_redis",<br>        "start_ip": "10.0.0.0"<br>      }<br>    ],<br>    "redis_version": 6,<br>    "sku_name": "Standard"<br>  },<br>  "np_medium": {<br>    "capacity": 4,<br>    "cluster_shard_count": 2,<br>    "patch_schedule": [<br>      {<br>        "day_of_week": "Monday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      },<br>      {<br>        "day_of_week": "Tuesday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      }<br>    ],<br>    "redis_configuration": {<br>      "maxfragmentationmemory_reserved": 1330,<br>      "maxmemory_delta": 1330,<br>      "maxmemory_policy": "allkeys-lru",<br>      "maxmemory_reserved": 1330<br>    },<br>    "redis_firewall_rules": [<br>      {<br>        "end_ip": "11.0.0.0",<br>        "name": "access_to_redis",<br>        "start_ip": "10.0.0.0"<br>      }<br>    ],<br>    "redis_version": 6,<br>    "sku_name": "Standard"<br>  },<br>  "np_small": {<br>    "capacity": 2,<br>    "cluster_shard_count": 2,<br>    "patch_schedule": [<br>      {<br>        "day_of_week": "Monday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      },<br>      {<br>        "day_of_week": "Tuesday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      }<br>    ],<br>    "redis_configuration": {<br>      "maxfragmentationmemory_reserved": 299,<br>      "maxmemory_delta": 299,<br>      "maxmemory_policy": "allkeys-lru",<br>      "maxmemory_reserved": 299<br>    },<br>    "redis_firewall_rules": [<br>      {<br>        "end_ip": "11.0.0.0",<br>        "name": "access_to_redis",<br>        "start_ip": "10.0.0.0"<br>      }<br>    ],<br>    "redis_version": 6,<br>    "sku_name": "Standard"<br>  },<br>  "pre_large": {<br>    "capacity": 5,<br>    "cluster_shard_count": 4,<br>    "patch_schedule": [<br>      {<br>        "day_of_week": "Monday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      },<br>      {<br>        "day_of_week": "Tuesday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      }<br>    ],<br>    "redis_configuration": {<br>      "maxfragmentationmemory_reserved": 2704,<br>      "maxmemory_delta": 2704,<br>      "maxmemory_policy": "allkeys-lru",<br>      "maxmemory_reserved": 2704<br>    },<br>    "redis_firewall_rules": [<br>      {<br>        "end_ip": "11.0.0.0",<br>        "name": "access_to_redis",<br>        "start_ip": "10.0.0.0"<br>      }<br>    ],<br>    "redis_version": 6,<br>    "sku_name": "Standard"<br>  },<br>  "pre_medium": {<br>    "capacity": 4,<br>    "cluster_shard_count": 2,<br>    "patch_schedule": [<br>      {<br>        "day_of_week": "Monday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      },<br>      {<br>        "day_of_week": "Tuesday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      }<br>    ],<br>    "redis_configuration": {<br>      "maxfragmentationmemory_reserved": 1330,<br>      "maxmemory_delta": 1330,<br>      "maxmemory_policy": "allkeys-lru",<br>      "maxmemory_reserved": 1330<br>    },<br>    "redis_firewall_rules": [<br>      {<br>        "end_ip": "11.0.0.0",<br>        "name": "access_to_redis",<br>        "start_ip": "10.0.0.0"<br>      }<br>    ],<br>    "redis_version": 6,<br>    "sku_name": "Standard"<br>  },<br>  "pre_small": {<br>    "capacity": 2,<br>    "cluster_shard_count": 2,<br>    "patch_schedule": [<br>      {<br>        "day_of_week": "Monday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      },<br>      {<br>        "day_of_week": "Tuesday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      }<br>    ],<br>    "redis_configuration": {<br>      "maxfragmentationmemory_reserved": 299,<br>      "maxmemory_delta": 299,<br>      "maxmemory_policy": "allkeys-lru",<br>      "maxmemory_reserved": 299<br>    },<br>    "redis_firewall_rules": [<br>      {<br>        "end_ip": "11.0.0.0",<br>        "name": "access_to_redis",<br>        "start_ip": "10.0.0.0"<br>      }<br>    ],<br>    "redis_version": 6,<br>    "sku_name": "Standard"<br>  },<br>  "prod_large": {<br>    "capacity": 5,<br>    "cluster_shard_count": 4,<br>    "patch_schedule": [<br>      {<br>        "day_of_week": "Monday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      },<br>      {<br>        "day_of_week": "Tuesday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      }<br>    ],<br>    "redis_configuration": {<br>      "maxfragmentationmemory_reserved": 2704,<br>      "maxmemory_delta": 2704,<br>      "maxmemory_policy": "allkeys-lru",<br>      "maxmemory_reserved": 2704<br>    },<br>    "redis_firewall_rules": [<br>      {<br>        "end_ip": "11.0.0.0",<br>        "name": "access_to_redis",<br>        "start_ip": "10.0.0.0"<br>      }<br>    ],<br>    "redis_version": 6,<br>    "sku_name": "Premium"<br>  },<br>  "prod_medium": {<br>    "capacity": 4,<br>    "cluster_shard_count": 2,<br>    "patch_schedule": [<br>      {<br>        "day_of_week": "Monday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      },<br>      {<br>        "day_of_week": "Tuesday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      }<br>    ],<br>    "redis_configuration": {<br>      "maxfragmentationmemory_reserved": 1330,<br>      "maxmemory_delta": 1330,<br>      "maxmemory_policy": "allkeys-lru",<br>      "maxmemory_reserved": 1330<br>    },<br>    "redis_firewall_rules": [<br>      {<br>        "end_ip": "11.0.0.0",<br>        "name": "access_to_redis",<br>        "start_ip": "10.0.0.0"<br>      }<br>    ],<br>    "redis_version": 6,<br>    "sku_name": "Premium"<br>  },<br>  "prod_small": {<br>    "capacity": 2,<br>    "cluster_shard_count": 2,<br>    "patch_schedule": [<br>      {<br>        "day_of_week": "Monday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      },<br>      {<br>        "day_of_week": "Tuesday",<br>        "maintenance_window": "PT5H",<br>        "start_hour_utc": 6<br>      }<br>    ],<br>    "redis_configuration": {<br>      "maxfragmentationmemory_reserved": 299,<br>      "maxmemory_delta": 299,<br>      "maxmemory_policy": "allkeys-lru",<br>      "maxmemory_reserved": 299<br>    },<br>    "redis_firewall_rules": [<br>      {<br>        "end_ip": "11.0.0.0",<br>        "name": "access_to_redis",<br>        "start_ip": "10.0.0.0"<br>      }<br>    ],<br>    "redis_version": 6,<br>    "sku_name": "Premium"<br>  }<br>}</pre> | no |
...
| <a name="input_region_map"></a> [region\_map](#input\_region\_map) | n/a | <pre>map(object({<br>    location_name = string<br>  }))</pre> | <pre>{<br>  "australiaeast": {<br>    "location_name": "aue"<br>  },<br>  "australiasoutheast": {<br>    "location_name": "ase"<br>  },<br>  "canadacentral": {<br>    "location_name": "cac"<br>  },<br>  "canadaeast": {<br>    "location_name": "cae"<br>  },<br>  "centralus": {<br>    "location_name": "uc"<br>  },<br>  "eastus2": {<br>    "location_name": "ue2"<br>  },<br>  "northeurope": {<br>    "location_name": "eun"<br>  },<br>  "westeurope": {<br>    "location_name": "euw"<br>  }<br>}</pre> | no |
